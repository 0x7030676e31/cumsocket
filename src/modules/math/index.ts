...
export default class Math {
  ...
  public get result(): string | null {
    ...
    if (!this._result.isFinite() && this._result.isNeg()) return "Infinitely small numbers sounds very interesting, isn't it? I'm not sure if I can calculate that though";
